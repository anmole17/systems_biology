...
pheatmap(data ,scale = "row", clustering_distance_rows="correlation", cluster_rows=TRUE, clustering_distance_cols="correlation", cluster_cols=TRUE, color = colorRampPalette(c("red","white","green")) (100),margins=c(8,8),fontsize = 6, cex = 1.2, show_rownames=TRUE, main="")
