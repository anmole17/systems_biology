...
## connects successive pairs. N1->N2, N2->N3, N3->N4, N4->N1, N1->N5, N2->N5 with 2 isolates N6, N7
...
E(gr1_dir)$weight <- c(1.5, 2.0, 4.0, 2.5, 1.9, 1.0)

X11()
plot(gr1_dir)
## we can also tamper with parameters
X11()
plot(gr1_dir, vertex.label.cex=0.3,vertex.label.dist=2.6, edge.arrow.size=0.5)
